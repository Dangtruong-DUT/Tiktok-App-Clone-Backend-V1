function LikeIcon({ className, width = '2.4rem', height = '2.4rem', color = 'currentColor', rotate = '0deg' }) {
    return (
        <svg  viewBox="0 0 24 24" className={className} style={{ transform: `rotate(${rotate})` }} width={width} height={height} fill={color} xmlns="http://www.w3.org/2000/svg">
            ...
            11.75 18.5C10.3127 18.5 5.61087 15.8131 2.40179 12.1998Z" fill-opacity="0.03"></path>
            ...
            15.8131 2.40179 12.1998Z" fill-opacity="0.03"></path>
            ...
            <clipPath id="HeartFill_clip0"><rect width="24" height="24" fill="white"></rect></clipPath></defs>
        </svg>
    );
}
